...
export const ChatProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const [model, setModel] = useState<any>({ name: "OpenAI: openai/gpt-oss-120b:nitro", provider: "OpenAI", name_id: "openai/gpt-oss-120b:nitro", cost_per_input_token: 0.10, cost_per_output_token: 0.40 });
