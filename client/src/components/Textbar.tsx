...
const Textbar = () => {
    ...
    const styles = {
        container: `w-full max-w-2xl border rounded-2xl p-2 flex flex-col gap-2 transition-all duration-300 ${
            isDark 
        ...
        input: `flex-1 p-3 focus:outline-none bg-transparent ${isDark ? "text-white placeholder-neutral-500" : "text-neutral-900 placeholder-neutral-400"}`,
        sendBtn: `p-2.5 rounded-xl transition-all active:scale-95 flex items-center justify-center ${
        ...
        fileItem: `relative group flex items-center gap-2 border rounded-lg p-1.5 pr-8 ${
        ...
        <div className={styles.container} ref={menuRef}>
            ...
            <div className="flex items-center justify-between px-2 pb-1">
                <div className="flex items-center gap-3">
                    ...
                    <button 
                        className={`transition-all relative flex items-center gap-0 px-2 py-1 rounded-full ${
                            isGroundingActive ? 'bg-blue-500/10 text-blue-500' : styles.iconBtn
                        }`}
