            ...
            <div className={`flex-1 overflow-y-auto  py-4 space-y-6 ${!allowedCustomInstructions ? "opacity-40 pointer-events-none " : ""}`}>
                ...
                <section>
                    ...
                    <div className="mt-4">
                        ...
                        <textarea
                            ...
                            defaultValue={tone === 'student' ? "Spiega i concetti come se avessi 12 anni." : ""}
                        />
                ...
                <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <InputGroup label="Come ti chiami?" placeholder="Es. Mario Rossi" />
                        <InputGroup label="Di cosa ti occupi?" placeholder="Es. Sviluppatore React" />
                        <InputGroup label="Hobby o interessi?" placeholder="Es. Trekking, Fotografia" />
                    </div>
                </section>
