...
import { OPENROUTER_KEY, SUPABASE_KEY, SUPABASE_URL } from "../config/enviroments.js";
 ...
 */
export async function ingestDocument(req: express.Request, res: express.Response) {
    try {
 ...
 */
export async function askPdf(req: express.Request, res: express.Response) {
